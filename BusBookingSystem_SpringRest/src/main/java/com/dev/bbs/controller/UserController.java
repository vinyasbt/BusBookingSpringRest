...
public class UserController {
	...
	public List<Bus> searchBus(@PathVariable("source") String source, @PathVariable("destination") String destination,
	...
	@PostMapping(path = "/book/ticket", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(path = "/give-feedback", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@DeleteMapping(path = "/cancel/ticket/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = "/get/ticket/{booking_id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = "/get/all-tickets/{userId}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = "/check-availability/{bus_id}/{journeyDate}", produces = MediaType.APPLICATION_JSON_VALUE)
	public Integer checkAvailability(@PathVariable("bus_id") int bus_id,
	...
	@GetMapping(path = "/printticket/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
